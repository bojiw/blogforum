package com.blogforum.manager.pojo.page;
...
public class Page<T> {
	...
	public String toString() {
		...
		// sb.append("共 " + count + "
		// 条"+(message!=null?message:"")+"</a></li>\n");
		// sb.append("<li>共 " + count + "
		// 条"+(message!=null?message:"")+"</li>\n");
		sb.append("<li class=\"disabled\"><span>每页  " + pageSize + " 条，共 " + count + " 条记录</span></li>");
